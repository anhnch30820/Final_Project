...
from tools.BBAM.data_utils import BBAM_data_loader, BBAM_data_loader_coco
import random
import copy
...
data_dir = '/content/drive/MyDrive/PJ3/Data/train/train'

image_root = os.path.join(data_dir, 'JPEGImages')

save_path_root = 'Faster_COCO_val'
...
def process(query):
    ...
    BBAM_dataset = BBAM_data_loader_coco(data_dir=data_dir, split=mode, cfg=cfg)
